...
public class MenuBuilder {
  public static void main(String[] args) {
    ...
    // Dream Menu:".
String meniTitle = "My Dream Menu";
    // Print the menuTitle variable to the console.
    System.out.println(meniTitle);
    ...
    MenuItem starter = new MenuItem("Calafiori");
    ...
    MenuItem mainCourse = new MenuItem("fishpie");
...
menu.add(mainCourse);
    ...
    MenuItem dessert = new MenuItem("douhg");
